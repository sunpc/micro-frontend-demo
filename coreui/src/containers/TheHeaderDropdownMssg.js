...
class TheHeaderDropdownMssg extends Component {
  ...
  constructor(props) {
    super(props);
    // watch
    let w = watch(store.getState, 'msgCount')
    ...
    return (
      ...
      >
        <CDropdownToggle className="c-header-nav-link" caret={false}>
          <CIcon name="cil-envelope-open" /><CBadge shape="pill" color="info">{this.state.msgCount}</CBadge>
        </CDropdownToggle>
        <CDropdownMenu className="pt-0" placement="bottom-end">
          <CDropdownItem
            ...
            color="light"
          >
            <strong>You have {this.state.msgCount} new message(s)</strong>
          </CDropdownItem>
          <CDropdownItem href="#">
